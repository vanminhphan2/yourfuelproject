  ...
  void login(BuildContext context,String phone, String pass)async{
    ...
    if (phone.isEmpty || phone.length !=10) {
      appController.dialog.showDefaultDialog(
          title: "Thong bao!", message: "Sai sdt!");
      return;
    }

    if (pass.isEmpty || pass.length <6) {
      appController.dialog.showDefaultDialog(
          title: "Thong bao!", message: "Sai pass!");
      return;
    }
    ...
    if(isExitsPhone){
      ...
      print("check login pass: ${AppHelper.generateMd5(pass)}     passServer: $passServer");
      if(AppHelper.generateMd5(pass)==passServer){
        ...
        appController.dialog.showDefaultDialog(
            title: "Thong bao!", message: "Sai mat khau!");
      }
    }else{
      appController.dialog.showDefaultDialog(
